...
const scenarios = [
  { name:'거팅 위험', params:{tugSteeringAngle:72,towLineLength:26,shipSpeed:8.5,propellerRpm:60,quickReleaseActive:false}},
  { name:'후류 진입', params:{tugSteeringAngle:4,towLineLength:28,shipSpeed:9,propellerRpm:115,quickReleaseActive:false}},
  { name:'선체 근접', params:{tugSteeringAngle:-22,towLineLength:14,shipSpeed:10,propellerRpm:50,quickReleaseActive:false}},
